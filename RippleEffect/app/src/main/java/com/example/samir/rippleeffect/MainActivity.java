package com.example.samir.rippleeffect;
...
import com.example.mylibrary.RippleView;
    ...
    private void call() {
        ...
        if (isRecyclerview)
        {
            ...
            customAdapter.setOnTapListener(new OnTapListener()
            {
                ...
                {
                    Toast.makeText(MainActivity.this, "RecycleView", Toast.LENGTH_SHORT).show();

                    startActivity(new Intent(MainActivity.this,AnoutherActivity.class));
